function ProjectDoc(){
    const projects = [
        ...
        {
            title : "Secrets",
            content : "Secrets App allows user Login and Registration using email as well as Google OAuth 2. It stores the data in the MongoDB database.",
            lnk : "https://secrets-2pln.onrender.com/",
             
        },
        {
            title : "Keeper App",
            content : "Keeper App is built using React components. It allows the user to create small notes along with the title. These can very easily be created and deleted.",
