function PythonDoc(){
    const docs = [
        ...
        },
        {
            ...
            para:"Interconversion between different data types is essential in real-time applications.",
            lnk:"https://www.scaler.com/topics/python-create-dictionary-from-lists/"
        },
        {
            title:"What are The Lists in Python?",
            para:"The list in Python is a data structure used to store the collection of items that can be of various different data types. They are dynamically allocated i.e. their",
            lnk:"https://www.studytonight.com/post/lists-in-python"
        }
    ]
    return docs;
}
