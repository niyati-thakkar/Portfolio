function CppDoc(){
    const docs = [
        ...
        },
        {
            ...
            para:"The Caesar Cipher is one of the oldest methods to convert data into a format such that it cannot be recognized by unauthorized users.",
            lnk:"https://www.scaler.com/topics/caesar-cipher-program-in-c/"
        },
        {
            title:"Radix Sort Program in C",
            para:"Radix sort is a sorting algorithm that is used to arrange the elements of an array in a particular sorted order.",
            lnk:"https://www.scaler.com/topics/radix-sort-program-in-c/"
        }
    ]
    return docs;
}
export default CppDoc;